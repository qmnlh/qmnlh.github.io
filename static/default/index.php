...
<head>
    ...
    <title><?=$XIAOYU['site_info']['title'];?>-<?=$XIAOYU['site_info']['site'];?></title>
        ...
        <div class="neirong">
            <div class="tu">
                <a href="/" title="<?=$XIAOYU['site_info']['site']?>">
                    <img class="lazy" data-original="/static/images/logo.png" src="/static/images/logo.png">
                </a>
            </div>
            <ul>
...
<div class="about_us w100" id="about">
    <div class="neirong">
        ...
        <ul>
            ...
            <li>
                <h4>宝宝起名哪里好？专业起名就找<?=$XIAOYU['site_info']['site']?>！</h4>
